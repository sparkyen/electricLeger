/*
 ...
 # Author: Brian Wu
 # WholesalerService -wholesalerDistribute:
 */
  ...
  **/
   async wholesalerDistribute(userName, equipmentNumber, ownerName) {
    ...
    try {
      ...
      let connectionProfile = yaml.safeLoad(fs.readFileSync('../../pln/organizations/peerOrganizations/org2.example.com/connection-org2.json', 'utf8'));
